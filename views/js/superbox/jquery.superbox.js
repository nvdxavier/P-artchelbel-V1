		...
		iframe: function($elt, curSettings){
			...
			$elt.click(function(e){
				...
				initLoading(function(){
					...
					// iframe
					$iframe = $('<iframe class="iframe-ratio" src="'+ $elt.attr("href") +'" name="'+ $elt.attr("href") +'" frameborder="0" scrolling="auto" hspace="0" width="'+ curSettings.boxWidth +'" height="'+ curSettings.boxHeight +'"></iframe>');
